...
def calcProb(team1,team2,year):
    ...
    threeper1,threeacc1 = teamstats(year,team1)
    threeper2,threeacc2 = teamstats(year,team2)
    el1 =  el1+ -6000/7*threeper1 +(1950/7)
    el2 = el2+ -6000/7*threeper2 +(1950/7)
